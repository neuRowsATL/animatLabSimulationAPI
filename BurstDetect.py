...
fldrResults = "F:/SimulationData/Interactions_CL/" + simSet
# Set analysis results folder
fldrAnalysis = "C:/HybridDynamics/HybridAnalysis/data/20111105K"
...
for fileResult in glob.glob("*.txt"):
    try:
        ...
        logFile.write("ANALYZING SPIKES: %s\n" % fileResult)
    ...
    try:
        ...
        if simSet <> "":
            f = open(fldrAnalysis + "/spikes/" + simSet + "/Evs-" + strDepCol.replace(" ", "") + "_" + fileResult, "w+")
        else:
            f = open(fldrAnalysis + "/spikes/Evs-" + strDepCol.replace(" ", "") + "_" + fileResult, "w+")
    ...
    try:
        ...
        if simSet <> "":
            f = open(fldrAnalysis + "/spikes/" + simSet + "/Evs-" + strLevCol.replace(" ", "") + "_" + fileResult, "w+")
        else:
            f = open(fldrAnalysis + "/spikes/Evs-" + strLevCol.replace(" ", "") + "_" + fileResult, "w+")
...
os.chdir('C:/HybridDynamics/HybridAnalysis/data/20111105K/spikes/dep')
for fileResult in glob.glob("*.txt"):
    try:
        logFile.write("\n\nLoading data: %s" % fileResult)
        if simSet <> "":
            fDepSpikes = open(fldrAnalysis + "/spikes/" + simSet + "/Evs-" + strDepCol.replace(" ", "") + "_" + fileResult, "r")
        else:
            ...
            fDepSpikes = open(fldrAnalysis + "/spikes/dep/" + fileResult, "r")
        ...
        # Save burst data
        if simSet <> "":
            fDepBursts = open(fldrAnalysis + "/bursts/" + simSet + "/burstEvs-" + strDepCol.replace(" ", "") + "_" + fileResult, "w+")
        else:
            # For AnimatLab-generated simulation data
            #fDepBursts = open(fldrAnalysis + "/bursts/burstEvs-" + strDepCol.replace(" ", "") + "_" + fileResult, "w+")
            # For DataView-exported experiment data
            fDepBursts = open(fldrAnalysis + "/bursts/dep/burstEvs-" + fileResult, "w+")
        arrWrite = []
        for b in depBursts:
...
os.chdir('C:/HybridDynamics/HybridAnalysis/data/20111105K/spikes/lev')
for fileResult in glob.glob("*.txt"):
    try:
        logFile.write("\n\nLoading data: %s" % fileResult)
        if simSet <> "":
            fLevSpikes = open(fldrAnalysis + "/spikes/" + simSet + "/Evs-" + strLevCol.replace(" ", "") + "_" + fileResult, "r")
        else:
            # For AnimatLab-generated simulation data
            #fLevSpikes = open(fldrAnalysis + "/spikes/Evs-" + strLevCol.replace(" ", "") + "_" + fileResult, "r")
            # For DataView-exported experiment data
            fLevSpikes = open(fldrAnalysis + "/spikes/lev/"+fileResult, "r")
        ...
        if simSet <> "":
            ...
            #fLevBursts = open(fldrAnalysis + "/bursts/" + simSet + "/burstEvs-" + strLevCol.replace(" ", "") + "_" + fileResult, "w+")
            # For DataView-exported experiment data
            fLevBursts = open(fldrAnalysis + "/bursts/lev/burstEvs-" + fileResult, "w+")
