...
class SelectInListV():
    ...
    def __init__(self, root, title="liste", nameList=['Parameter1'],
                 ...
                 secondCheck=0, thirdCheck=0, numbered=0, coul='red'):
        self.coul = coul
...
class ReadAsimAform(QtGui.QMainWindow, design2.Ui_MainWindow):
    def __init__(self):
    ...
    def cell_was_clicked(self, tableWidgt, listName, row, column, col):
        firstChkList = []
        secondChkList = []
        firstListNb = []
        secondListNb = []
        ...
        return [firstListNb, secondListNb]
